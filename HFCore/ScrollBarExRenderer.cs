namespace Haltroyify
{
   ...
   internal static class ScrollBarExRenderer
   {
      ...
      private static void DrawBackgroundVertical(Graphics g, Rectangle rect)
      {
         ...
         {
            g.FillRectangle(Brushes.White, firstRect);
         }

       
         {
            g.FillRectangle(Brushes.White, secondRect);
         }
      }
      ...
      private static void DrawTrackVertical(Graphics g, Rectangle rect)
      {
        ...
        
         {
                ...
                g.FillRectangle(brushwhite, innerRect);
            }
      }
         ...
         ScrollBarArrowButtonState state)
      {
         ...
         using (Graphics g = Graphics.FromImage(bitmap))
         {
            ...
            if (index != -1)
            {
               ...
               {
                  g.FillRectangle(Brushes.White, upper);
               }
               ...
               {
                  g.FillRectangle(Brushes.White,lower);
               }
