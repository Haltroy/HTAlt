...
namespace Haltroyify
{
    ...
    public class WebtroySwitch : Control
    {
        ...
        public enum WebtroySwitchStyle
        {
            Metro,
            Android,
            IOS5,
        ...
        public enum WebtroySwitchAlignment
        {
            Near,
            Center,
            Far
        ...
        public enum WebtroySwitchButtonAlignment
        {
            Left,
            Center,
            Right
        ...
        private WebtroySwitchRendererBase _renderer;

        private WebtroySwitchStyle _style = WebtroySwitchStyle.Metro;
        ...
        private WebtroySwitchButtonAlignment _buttonAlignment = WebtroySwitchButtonAlignment.Center;
        ...
        private WebtroySwitchAlignment _offSideAlignment = WebtroySwitchAlignment.Center;
        private Image _offButtonImage = null;
        private bool _offButtonScaleImage;
        private WebtroySwitchButtonAlignment _offButtonAlignment = WebtroySwitchButtonAlignment.Center;
        ...
        private WebtroySwitchAlignment _onSideAlignment = WebtroySwitchAlignment.Center;
        private Image _onButtonImage = null;
        private bool _onButtonScaleImage;
        private WebtroySwitchButtonAlignment _onButtonAlignment = WebtroySwitchButtonAlignment.Center;

        #endregion Private Members

        #region Constructor Etc.

        public WebtroySwitch()
        {
            ...
            SetRenderer(new WebtroySwitchMetroRenderer());
        ...
        public void SetRenderer(WebtroySwitchRendererBase renderer)
        {
            renderer.SetWebtroySwitch(this);
            _renderer = renderer;
        ...
        [Bindable(false)]
        [DefaultValue(typeof(WebtroySwitchStyle), "Metro")]
        [Category("Appearance")]
        [Description("Gets or sets the style of the WebtroySwitch")]
        public WebtroySwitchStyle Style
        {
            get { return _style; }
            set
            {
                if (value != _style)
                {
                    ...
                    switch (_style)
                    {
                        case WebtroySwitchStyle.Metro:
                            SetRenderer(new WebtroySwitchMetroRenderer());
                            break;
                        case WebtroySwitchStyle.Android:
                            SetRenderer(new WebtroySwitchAndroidRenderer());
                            break;
                        case WebtroySwitchStyle.IOS5:
                            SetRenderer(new WebtroySwitchIOS5Renderer());
                            break;
                        case WebtroySwitchStyle.BrushedMetal:
                            SetRenderer(new WebtroySwitchBrushedMetalRenderer());
                            break;
                        case WebtroySwitchStyle.OSX:
                            SetRenderer(new WebtroySwitchOSXRenderer());
                            break;
                        case WebtroySwitchStyle.Carbon:
                            SetRenderer(new WebtroySwitchCarbonRenderer());
                            break;
                        case WebtroySwitchStyle.Iphone:
                            SetRenderer(new WebtroySwitchIphoneRenderer());
                            break;
                        case WebtroySwitchStyle.Fancy:
                            SetRenderer(new WebtroySwitchFancyRenderer());
                            break;
                        case WebtroySwitchStyle.Modern:
                            SetRenderer(new WebtroySwitchModernRenderer());
                            break;
                    }
                }
        ...
        [DefaultValue(false)]
        [Category("Data")]
        [Description("Gets or sets the Checked value of the WebtroySwitch")]
        public bool Checked
        {
            get { return _checked; }
            set
        ...
        [DefaultValue(true)]
        [Category("Appearance")]
        [Description("Gets or sets if the WebtroySwitch should be grayed out when disabled")]
        ...
        [DefaultValue(true)]
        [Category("Behavior")]
        [Description("Gets or sets if the WebtroySwitch should toggle when the button is clicked")]
        ...
        [DefaultValue(true)]
        [Category("Behavior")]
        [Description("Gets or sets if the WebtroySwitch should toggle when the track besides the button is clicked")]
        ...
        [Bindable(false)]
        [DefaultValue(typeof(WebtroySwitchButtonAlignment), "Center")]
        [Category("Appearance")]
        [Description("Gets or sets how the button image visible when Checked=false should be aligned")]
        public WebtroySwitchButtonAlignment OffButtonAlignment
        {
        ...
        public WebtroySwitchButtonAlignment ButtonAlignment
        {
        ...
        public WebtroySwitchAlignment OnSideAlignment
        {
        ...
        public WebtroySwitchButtonAlignment OnButtonAlignment
        {
