...
{
    public class WebtroySwitchBrushedMetalRenderer : WebtroySwitchRendererBase
    {
        #region Constructor

        public WebtroySwitchBrushedMetalRenderer()
        {
        ...
        public override void RenderBorder(Graphics g, Rectangle borderRectangle)
        {
            ...
            using (GraphicsPath outerControlPath = GetRectangleClipPath(borderRectangle))
            {
                ...
                Color borderColor1 = (!WebtroySwitch.Enabled && WebtroySwitch.GrayWhenDisabled) ? BorderColor1 : BorderColor1;
                Color borderColor2 = (!WebtroySwitch.Enabled && WebtroySwitch.GrayWhenDisabled) ? BorderColor2 : BorderColor2;
        ...
        public override void RenderLeftToggleField(Graphics g, Rectangle leftRectangle, int totalToggleFieldWidth)
        {
            ...
            Rectangle innercontrolRectangle = new Rectangle(1, 1, WebtroySwitch.Width - 1, WebtroySwitch.Height - 2);
        ...
        public override void RenderButton(Graphics g, Rectangle buttonRectangle)
        {
            ...
            if (!WebtroySwitch.Enabled && WebtroySwitch.GrayWhenDisabled)
                buttonSurfaceColor = buttonSurfaceColor;
