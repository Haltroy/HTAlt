...
{
    public class WebtroySwitchCarbonRenderer : WebtroySwitchRendererBase, IDisposable
    {
        #region Constructor

        private GraphicsPath _innerControlPath = null;

        public WebtroySwitchCarbonRenderer()
        {
        ...
        {
            float buttonWidth = 1.61f*(WebtroySwitch.Height - 2);
