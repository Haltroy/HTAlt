...
namespace Haltroyify
{
    ...
    public class WebtroyTabControl : TabControl
    {
        /// <summary>
                ...
                for (var i = 0; i < this.TabCount; i++)
                {
                    ...
                    if (this.ShowClosingMessage)
                    {
                        if (DialogResult.Yes == MessageBox.Show(this.ClosingMessage, "Close", MessageBoxButtons.YesNo))
                        {
                            ...
                            else  {this.TabPages.RemoveAt(i);}
                        }
                    }
                    else
                    {
                        if (i == this.TabPages.IndexOf(donotmoveorremovethistab1)) { }
                        else if (i == this.TabPages.IndexOf(donotmoveorremovethistab2)) { }
                        else
                        {
